...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.setDescription(
			"Displays the current count of members of each watched role."
		)
				...
				.addChoices(
					{
						...
						value: "country",
						description:
							"Fully independent countries looking for new players",
					},
					{
						name: "Subject",
						value: "subject",
						description: "States under independent countries",
					},
					{
						name: "City-State",
						value: "city-state",
						description:
							"Fully independent states NOT looking for new players and/or inactive",
					},
					{
						name: "Organisation",
						value: "organisation",
					...
					},
					{
						name: "Religion",
						value: "religion",
						description: "Faith or sets of beliefs",
					}
				)
		),
	execute: async ({ client, interaction }) => {
		...
		statusMessages({ client, interactionGuildId }).then(
			async ({
				countries,
				city_states,
				subjects,
